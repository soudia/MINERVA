...
export PYTHONPATH="."
gpu_id=1
cmd="python -W ignore $script_dir/trainer.py --base_output_dir $base_output_dir --path_length $path_length --hidden_size $hidden_size --embedding_size $embedding_size \
